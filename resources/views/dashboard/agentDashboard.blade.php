                ...
                <div class="col-md-12 grid-margin">
                    <div class="d-flex justify-content-between flex-wrap">
                        ...
                        <div class="card-body border-top">
                            ...
                            <p></p><hr />
              <p class="mb-0">
                Please Complete Your Profile Set-Up to Use the system!<a href="/agent/create/post">Click here</a></p>
            </div>
            @endif
                            </div>
                            <div class="d-flex">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-xl-between">
                                     <div
                                            ...
                                            <div class="d-flex flex-column justify-content-around">
                                                <small class="mb-1 text-muted">{{__('Orders')}}</small>
                                                <div class="dropdown">
                                                    <a class=""
                                                        href="/order/show" role="button" id="dropdownMenuLinkA"
                                                        data-bs-toggle="dropdown" aria-haspopup="true"
                                                        aria-expanded="false">
                                                        <h5 class="mb-0 d-inline-block">To date</h5>
                                                    </a>
                                        ...
                                        <div
                                            ...
                                            <i class="mdi mdi-checkbox-multiple-marked me-3 icon-lg text-danger"></i>
                                            <div class="d-flex flex-column justify-content-around">
                                                <small class="mb-1 text-muted">{{ __('ConfirmedOrders') }}</small>
                                                <h5 class="me-2 mb-0">{{ $confirm }}</h5>
                                            </div>
                                        </div>
                                        <div
                                            class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                                            <i class="mdi mdi-clipboard-alert me-3 icon-lg text-success"></i>
                                            <div class="d-flex flex-column justify-content-around">
                                                <small class="mb-1 text-muted">
                                                    {{ __('UnConfirmedOrders') }}</small>
                                                <h5 class="me-2 mb-0">{{ $unconfirm }}</h5>
                                            </div>
                                        </div>
                                        <div
                                            class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                                            <i class="mdi mdi-cart me-3 icon-lg text-warning"></i>
                                            <div class="d-flex flex-column justify-content-around">
                                                <small class="mb-1 text-muted">
                                                    {{ __('DeliveredOrders') }}</small>
                                                <h5 class="me-2 mb-0">{{ $delieverd }}</h5>
                                            </div>
                                        </div>
                ...
                {{-- <div class="col-md-7 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <canvas id="agent-cash-deposits-chart"></canvas>
                        </div>
                    </div>
                </div> --}}
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                            ...
                                            <td><form action="{{ ('/order/details') }}" method="POST">
                                             ...
                                             <button type="submit" class="btn btn-outline-success" >{{__('messages.ViewDetails')}}</button>
                                              </form></td>
                                        </tr>
                               @endforeach
                                </table>
