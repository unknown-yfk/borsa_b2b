                ...
                <div class="col-md-12 grid-margin">
                    <div class="d-flex justify-content-between flex-wrap">
                        ...
                        <div class="card-body border-top">
                            ...
                            <p></p><hr />
              <p class="mb-0">
                Please Complete Your Profile Set-Up to Use the system!<a href="/rom/create">Click here</a></p>
            </div>
            @endif
                            <div class="d-flex">
                        ...
                        <div class="card-body dashboard-tabs p-0">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-xl-between">
                                        {{-- <div
                                            ...
                                            <div class="d-flex flex-column justify-content-around">
                                                <small class="mb-1 text-muted">{{__('Deliveries')}}</small>
                                                <div class="dropdown">
                                                    <a class=""
                                                        href="/delivery/history" role="button" id="dropdownMenuLinkA"
                                        ...
                                        <a class="text-decoration-none" href="/delivery_search">
                                            <div
                                                class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                          ...
                          <div class="d-flex flex-column justify-content-around">
                            ...
                            <h5 class="me-2 mb-0">2233783</h5>
                                        ...
                                        <a class="text-decoration-none" href="/rom/orders/show">
                                            <div
                                                ...
                                                <div class="d-flex flex-column justify-content-around">
                                                    <small class="mb-1 text-muted">New Orders</small>
                                                        ...
                                                        <h5 class="me-2 mb-0">{{$new}}</h5>
                                                </div>

                                            </div>
                                        </a>
                                          <a class="text-decoration-none" href="/rom/order/returned">
                                           <div
                                                class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
