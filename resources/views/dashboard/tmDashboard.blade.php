                ...
                <div class="col-md-12 grid-margin">
                    <div class="d-flex justify-content-between flex-wrap">
                        ...
                        <div class="card-body border-top">
                            ...
                            <p></p><hr />
              <p class="mb-0">
                Please Complete Your Profile Set-Up to Use the system!<a href="/key_distro/create/post">Click here</a></p>
            </div>
            @endif --}}
            </div>
                            <div class="d-flex">
...
<a class="text-decoration-none" href="/tm/orders/show">
                                            <div
                                        ...
                                        <a class="text-decoration-none" href="/tm/order/history">
                                            <div
                                        ...
                                        <a class="text-decoration-none" href="/tm/handover/history">
                                            <div
                                                class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
