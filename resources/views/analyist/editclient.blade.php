                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="form-sample" action="{{ url('/analyist/editedclientStore', $user->id) }}" method="POST"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text"
                                                    ...
                                                    id="middleName" name="middleName" value={{ $user->middleName }}>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text"
                                                    ...
                                                    id="Mother_name" name="Mother_name" value={{ $user->Mother_name }}>
                                                @error('Mother_name')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="PhoneType" name="PhoneType"
                                                    ...
                                                    <option value="{{ $user->PhoneType }}" selected>{{ $user->PhoneType }}
                                                    </option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value={{ $user->client_mobile_phone }}>
                                                @error('client_mobile')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="tel"
                                                    ...
                                                    value={{ $user->Alternative_Phone_Number }}>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number"
                                                    ...
                                                    id="FamilySize" name="FamilySize" value={{ $user->FamilySize }}>
                                                @error('FamilySize')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number"
                                                    ...
                                                    id="nochild" name="nochild" value="{{ $user->nochild }}">
                                                @error('nochild')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number"
                                                    ...
                                                    value="{{ $user->child_in_school_under2 }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text"
                                                    ...
                                                    id="camp" name="camp" value="{{ $user->camp }}">
                                                @error('camp')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text"
                                                    ...
                                                    id="zone" name="zone" value="{{ $user->zone }}">
                                                @error('zone')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text"
                                                    ...
                                                    id="kebele" name="kebele" value="{{ $user->kebele }}">
                                                @error('kebele')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="idType" name="ID_type"
                                                    ...
                                                    <option value="{{ $user->ID_type }}" selected>{{ $user->ID_type }}
                                                    </option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="unhcr_id" name="unhcr_id"
                                                    ...
                                                    <option value="{{ $user->unhcr_id }}" selected>{{ $user->unhcr_id }}
                                                    </option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text"
                                                    ...
                                                    value="{{ $user->client_business_Name }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="client_businessType" name="client_business_Type"
                                                    ...
                                                    <option value="{{ $user->client_business_Type }}">
                                                        {{ $user->client_business_Type }}</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text"
                                                    ...
                                                    value="{{ $user->businessRegisteration }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text"
                                                    ...
                                                    id="Tin_number" name="Tin_number" value="{{ $user->Tin_number }}">
                                                @error('Tin_number')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="kd" name="kd"
                                                    ...
                                                    <option value="{{ $key_distro[0]->user_id }}" selected>
                                                        {{ $key_distro[0]->firstName }}
                                                        {{ $key_distro[0]->middleName }} {{ $key_distro[0]->lastName }}
                                                    </option>

                                                    @foreach ($key_all as $kd)
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="agent_id" name="agent_id"
                                                    ...
                                                    required>
                                                    {{ sizeof($agent_se) }}
                                                    @if (sizeof($agent_se) > 0)
                                                        <option value="{{ $agent_se[0]->user_id }}">
                                                            {{ $agent_se[0]->firstName }}
                                                            {{ $agent_se[0]->middleName }} {{ $agent_se[0]->lastName }}
                                                        </option>
                                                    @else
                                                        <option value=" "></option>
                                                    @endif
                                                    @foreach ($agents as $agent)
                                                        <option value="{{ $agent->user_id }}"> {{ $agent->firstName }}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="workpermit" name="workpermit"
                                                    ...
                                                    required>
                                                    <option value="{{ $user->workpermit }}" selected>
                                                        {{ $user->workpermit }}</option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                                @error('workpermit')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="Bank_Account" name="Bank_Account"
                                                    ...
                                                    <option value="{{ $user->Bank_Account }}" selected>
                                                        {{ $user->Bank_Account }}</option>
                                                    <option value="Yes">Yes</option>
                                                    <option value="No">No</option>
                                                </select>
                                                @error('Bank_Account')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <select id="Bank_name" name="Bank_name"
                                                    ...
                                                    <option value="{{ $user->Bank_name }}" selected>
                                                        {{ $user->Bank_name }}</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="Community_Saving" name="Community_Saving"
                                                    ...
                                                    <option value="{{ $user->Community_Saving }}" selected>
                                                        {{ $user->Community_Saving }}</option>
                                                    <option value="Yes">Yes</option>
                                                    <option value="No">No</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="Community_loan" name="Community_loan"
                                                    ...
                                                    <option value="{{ $user->Community_loan }}" selected>
                                                        {{ $user->Community_loan }}</option>
                                                    <option value="Yes">Yes</option>
                                                    <option value="No">No</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        @if (isset($user->financialproduct_saving)) @if ($user->financialproduct_saving == 'saving') checked @endif
                                                        @endif>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="check1"
                                                            ...
                                                            @if (isset($user->financialproduct_loan)) @if ($user->financialproduct_loan == 'loan') checked @endif
                                                            @endif>
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" id="check1"
                                                            ...
                                                            @if (isset($user->financialproduct_remittance)) @if ($user->financialproduct_remittance == 'remittance') checked @endif
                                                            @endif>
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" id="check1"
                                                            ...
                                                            @if (isset($user->financialproduct_payment)) @if ($user->financialproduct_payment == 'payment') checked @endif
                                                            @endif>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select id="Receival_of_training" name="Receival_of_training"
                                                        ...
                                                        <option value="{{ $user->Receival_of_training }}" selected>
                                                            {{ $user->Receival_of_training }}</option>
                                                        <option value="Yes">Yes</option>
                                                        <option value="No">No</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text"
                                                        ...
                                                        value="{{ $user->Training_provided_by }}">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="check1"
                                                            ...
                                                            @if (isset($user->Training_module1)) @if ($user->Training_module1 == 'Module1') checked @endif
                                                            @endif>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="check1"
                                                            ...
                                                            @if (isset($user->Training_module2)) @if ($user->Training_module2 == 'Module2') checked @endif
                                                            @endif>
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" id="check1"
                                                            ...
                                                            @if (isset($user->Training_module3)) @if ($user->Training_module3 == 'Module3') checked @endif
                                                            @endif>
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="check1"
                                                            ...
                                                            @if (isset($user->areas_intrested_finance)) @if ($user->areas_intrested_finance == 'Finance & budget') checked @endif
                                                            @endif>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="check1"
                                                            ...
                                                            @if (isset($user->areas_intrested_scale)) @if ($user->areas_intrested_scale == 'Scale Business') checked @endif
                                                            @endif>
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" id="check1"
                                                            ...
                                                            @if (isset($user->areas_intrested_digitize)) @if ($user->areas_intrested_digitize == 'Digitize payment') checked @endif
                                                            @endif>
                                        ...
                                        <div class="form-group row">
                                           ...
                                           <div class="col-sm-9">
                                                <textarea class="form-control  @error('short_term_personal_goals') is-invalid @enderror"
                                                    id="short_term_personal_goals" name="short_term_personal_goals" >{{ $user->short_term_personal_goals }}</textarea>
                                            ...
                                            <div class="col-sm-9">
                                                <div class="form-check">
                                                    <select id="Desired_place_of_residence"
                                                        ...
                                                        <option value="{{ $user->Desired_place_of_residence }}" selected>
                                                            {{ $user->Desired_place_of_residence }}</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="leaveethiopia" name="leaveethiopia"
                                                    ...
                                                    <option value="{{ $user->leaveethiopia }}" selected>
                                                        {{ $user->leaveethiopia }}</option>
                                                    <option value="Yes">Yes</option>
                                                    <option value="No">No</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="when_leave" name="when_leave"
                                                    ...
                                                    <option value="{{ $user->when_leave }}" selected>
                                                        {{ $user->when_leave }}</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control  @error('Long_term_business_goals') is-invalid @enderror" id="Long_term_business_goals"
                                                        name="Long_term_business_goals" >{{ $user->Long_term_business_goals }}</textarea>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <textarea class="form-control  @error('Long_term_personal_goals') is-invalid @enderror" id="Long_term_personal_goals"
                                                        name="Long_term_personal_goals" >{{ $user->Long_term_personal_goals }}</textarea>
