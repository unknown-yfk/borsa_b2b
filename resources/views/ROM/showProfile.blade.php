              ...
              <div class="card">
                <div class="card-body">
                  ...
                  {{-- <form class="form-sample" action="/admin/create/user/post" method="POST" enctype="multipart/form-data"> --}}
                    ...
                    <div class="col-md-6"><label class="labels"><strong>KD</strong></label>
                    <p class="form-control">{{Helper::get_kd_name($profile->kd_id)}}</p></div>
                    ...
                    <p class="form-control">{{$profile->mobile}}</p></div>
                         ...
                         <div class="col-md-6"><label class="labels"><strong>ROM UNIQUE ID</strong></label>
                    <p class="form-control">{{$profile->rom_unique_id}}</p></div>
