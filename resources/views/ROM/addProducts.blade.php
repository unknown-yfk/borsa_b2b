                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-0 px-0">
                                    ...
                                    <div class="d-flex flex-column px-2"><span
                                            class="text-muted"><strong>{{ $product->id }}{{ $product->name }}</strong></span></div><br>
                                    ...
                                    <form action="/rom/StoreProducts" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <input type="hidden" value="{{ $product->name }}" name="name">
                                              <input type="hidden" value="{{ $kd_id[0]->kd_id }}" name="kd_id">
    <div>
  <small class="text-muted key pl-3" style="display: inline-block;"><code>Insert quantity here</code>:</small>
  <input type="number" id="Qty" name="Qty" class="form-control mx-3 @error('Qty') is-invalid @enderror" style="display: inline-block; width: 100px;" required>
