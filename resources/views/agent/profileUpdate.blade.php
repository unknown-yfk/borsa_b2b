              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <code> Edit your Profile Here!</code>
                    ...
                    <form action="/agent/update/store" method= "POST" enctype="multipart/form-data"></center>
                    ...
                    @method('PUT')
                       <div class="col-md-12">
                        ...
                        @error('userPhoto')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{__('messages.UserPhoto')}}</strong>
                            </span>
                            @enderror
                    </div>
                    </div>
                     <div class="row mt-2">
                        <div class="col-md-6 mt-6"><label class="labels"><strong> {{__('messages.FirstName')}}</strong></label>
                        <input type="text" class="form-control  @error('firstName') is-invalid @enderror" placeholder="First Name" id="firstName" name="firstName"  value="{{$profile->firstName }}" required>
                          @error('firstName')
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.MiddleName')}}</strong></label>
                        <input type="text" class="form-control @error('middleName') is-invalid @enderror"  placeholder="Middle Name" id="middleName" name="middleName"  value="{{$profile->middleName }}"required>
                            @error('middleName')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.LastName')}}</strong></label>
                        <input type="text" class="form-control   @error('lastName') is-invalid @enderror" placeholder="Last Name" id="lastName" name="lastName"  value="{{$profile->lastName }}"required>
                        @error('lastName')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.UserName')}}</strong></label>
                        <input type="text" class="form-control   @error('userName') is-invalid @enderror" placeholder="User Name" id="userName" name="userName"  value="{{$profile->userName }}"required>
                        @error('userName')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.Email')}}</strong></label>
                        <input type="email" class="form-control   @error('email') is-invalid @enderror" placeholder="" id="email" name="email"  value="{{$profile->email }}"required>
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.HomeAdress')}}</strong></label>
                        <input type="address" class="form-control @error('address') is-invalid @enderror" placeholder="your home address" id="address" name="address" value="{{$profile->address }}"required>
                        @error('address')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.Mobile')}}</strong></label>
                        <input type="text" class="form-control   @error('mobile') is-invalid @enderror"  placeholder="Phone number" id="mobile" name="mobile" value="{{$profile->mobile }}"required>
                        @error('mobile')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                     ...
                     <div class="row mt-2">
                    <div class="col-md-12"><label class="labels"><strong>{{__('messages.YourId')}}</strong></label>
                         <img src="../../assets/gov_img/{{$profile->id_file_path}}" class="rounded float-start" alt="{{ $profile->id_file_path }}" width="100rem" height="100rem">
                      ...
                      <div class="row mt-2">
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.IdType')}}</strong></label>
                        ...
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.IdNumber')}} </strong></label>
                        ...
                        <div class="col-md-6"><label class="labels"><strong>  {{__('messages.IdIssueDate')}}</strong></label>
                        ...
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.IdExpiryDate')}} </strong></label>
                        ...
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.BusinessName')}} </strong></label>
                     ...
                     <div class="col-md-6"><label class="labels"><strong> {{__('messages.BusinessType')}}</strong></label>
                        ...
                        <div class="col-md-6"> <label class="labels"><strong>{{__('messages.BusinessAdress')}}</strong></label>
                      ...
                      <div class="col-md-12">
                          <label class="labels"><strong> {{__('messages.BusinessLicence')}}</strong></label>
                     ...
                     <div class="row mt-2">
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.LicenceNumber')}}</strong> </label>
                        ...
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.LicenceIssueDate')}}</strong></label>
                        ...
                        <div class="col-md-6"><label class="labels"><strong> {{__('messages.ExpiryDate')}} </strong> </label>
                        ...
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.TinNumber')}}</strong></label>
                        ...
                        <div class="col-md-6"><label class="labels"><strong>{{__('messages.BusinessEstablished_at')}}</strong></label>
