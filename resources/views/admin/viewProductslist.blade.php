...
<div class="main-panel">
  ...
  <div class="col-sm-3 mb-3">
    ...
    <div class="card-body pt-0 px-0">
      ...
      <div class="d-flex flex-row justify-content-between p-3 mid">
        {{-- <div class="d-flex flex-column"><small class="text-muted mb-1">Quantity</small><div class="d-flex flex-row"><small class="ghj">1.4L MultiAir</small><small class="ghj">16V I-4 Turbo</small></div></div></div> --}}
        <div class="d-flex flex-column"><small class="text-muted mb-2">Minimum Order : {{ $product->min_order }}</small></div>
      </div>
      <div class="d-flex flex-row justify-content-between p-3 mid">
        {{-- <div class="d-flex flex-column"><small class="text-muted mb-1">Quantity</small><div class="d-flex flex-row"><small class="ghj">1.4L MultiAir</small><small class="ghj">16V I-4 Turbo</small></div></div></div> --}}
        <div class="d-flex flex-column"><small class="text-muted mb-2">Maximum Order : {{ $product->max_order }}</small></div>
      </div>
      {{-- <small class="text-muted key pl-3">Standard key Features</small> --}}
      <div class="mx-3 mt-3 mb-2 btn-group">
        <a href ="{{url('admin/edit/productlist',$product->id)}}"><button type="button" class="btn btn-success btn-block mx-3"><small>EDIT</small></button></a>
        <a href="{{url('admin/delete/productlist',$product->id)}}"><button type="button" class="btn btn-danger btn-block" onclick="return confirm('Do You Want To Delete This Product?')"><small>DELETE</i></small></button></a>
    </div>
