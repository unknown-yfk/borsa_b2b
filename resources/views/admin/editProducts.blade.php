              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <code> Edit Products Here!</code>
                        ...
                        <form action="{{url('/admin/editedProductStore',$products->id)}}" method= "POST" enctype="multipart/form-data"></center>
                            @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                 <label> Product Image</label>
                                  <img src="{{ asset('/assets/product_img/'.$products->image) }}" class="rounded float-start" alt="Product Image" width="100rem" height="100rem">
                                ...
                                <div class="mb-3"><label>Select Catagory</label>
                                            ...
                                            <select id="catagory" name="catagory" class="form-control" required>
                                                ...
                                                @foreach ($catagories as $catagory)
                                                    ...
                                                    <option value="{{ $catagory->id }}" {{ $products->catagory_id == $catagory->id ? 'selected' : ''}}> {{ $catagory->catagoryName }}</option>
                                ...
                                <div class="mb-3">
                                 <label>Price</label>
                                   <input type="number" pattern="[0-9]+([\.,][0-9]+)?" step="0.0000001" id="price" name="price" value="{{ $products->price }}"class="form-control">
                                </div>
                                <div class="mb-3">
