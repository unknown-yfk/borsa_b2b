        ...
        <div class="content-wrapper">
            <div class="row">
                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="mt-4">TM Registration</h1>
                            <div class="row">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="container rounded bg-white mt-5 mb-5">
                                            ...
                                            <div class="row mt-2">
                                                <center>
                                                    <form action="/admin/create/tm/post" method="POST"
                                                ...
                                                <div class="col-md-6"><label class="labels"><strong>Key Distributor
                                                        </strong></label>
                                                    <select id="kd_id" name="kd_id"
                                                        class="form-control @error('kd_id') is-invalid @enderror"
                                                        value="{{ old('kd_id') }}" required>
                                                        <option value=""></option>
