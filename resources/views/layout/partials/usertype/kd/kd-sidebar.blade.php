      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav  position-fixed">
            @if (auth()->user()->key_distro !== Null && auth()->user()->key_distro->has_tm==0)
              {{-- @if(auth()->user()->key_distro->has_tm==0) --}}
          ...
          {{-- <li class="nav-item">
           ...
           <li class="nav-item">
            ...
            <div class="collapse" id="ui-basi">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/key_distroProfile/show">Show Profile</a></li>
                <li class="nav-item"> <a class="nav-link" href="/key_distro/update/edit">Update Profile</a></li>
                <li class="nav-item"> <a class="nav-link" href="/key_distro/password/change">Change Password</a></li>
           ...
           <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/orders/show">unconfirmed Orders</a></li>
                <li class="nav-item"> <a class="nav-link" href="/order/history">Confirmed Orders<br>(to be handovered)</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basiccc">
              <ul class="nav flex-column sub-menu">
                {{-- <li class="nav-item"> <a class="nav-link" href="/key_distro/add/product">{{ __('messages.AddProducts') }}</a></li> --}}
                <li class="nav-item"> <a class="nav-link" href="/key_distro/view/product">{{ __('messages.ViewProducts') }}</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-Handover">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link"  href="/handover/history"> Handovered Orders</a></li>
                <li class="nav-item"> <a class="nav-link"  href="/undelivered/orders">Undelivered Products</a></li>
              </ul>
            </div>
          </li>
                <li class="nav-item">
            ...
            <div class="collapse" id="ui-Report">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/key_distro/report/order/accepted">Order Report</a></li>
                <li class="nav-item"> <a class="nav-link"  href="/key_distro/report/handover">Handover Report</a></li>
              </ul>
            </div>
          </li>
