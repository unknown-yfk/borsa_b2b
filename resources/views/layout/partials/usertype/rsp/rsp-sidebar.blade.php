      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav  position-fixed">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-Catagories">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/rspProfile/show">{{ __('show profile') }}</a></li>
                <li class="nav-item"> <a class="nav-link" href="/rsp/update/edit">{{ __('Update Profile') }}</a></li>
              </ul>
            </div>
          </li>
        ...
        {{-- <li class="nav-item">
            ...
            <div class="collapse" id="ui-Report">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/admin/payment/report">{{ __('Payment Report') }}</a></li>
                <li class="nav-item"> <a class="nav-link" href="/admin/lastMile/report">{{ __('Last Mile Delivery Report') }}</a></li>
              </ul>
            </div>
          </li> --}}
