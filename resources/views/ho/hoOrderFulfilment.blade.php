...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">BORSA ORDER FUlFILMENT SUMMARY REPORT </h4>
                    <p class="card-description">
                     ...
                     <input type="hidden" {{ $no = 0 }} />
                        ...
                        <input type="hidden" {{ $k = 6 }} />



                        <input type="hidden" {{ $size = sizeof($product) }} />
                    <div class="table-responsive pt-3">
                        <form action="{{ route('orderfulfilment') }}" method="GET" class="filter-form" id="filterForm">
                        ...
                        <table id="table" class="display nowrap" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $lastMileReport[$i]->deliveryDate }}</td>
                                    ...
                                    @php $products_id=explode(',', $lastMileReport[$i]->productlist_ids);
                                        ...
                                        @for ($r = 0; $r < sizeof($products_id); $r++)
                                            ...
                                            @php
                                            $quantities = explode(',', $lastMileReport[$i]->delivered_quantities);
