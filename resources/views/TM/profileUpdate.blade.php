                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/tm/update/edits" method="POST" enctype="multipart/form-data">
                                </center>
                                <div class="row mt-2">
                                    ...
                                    @foreach ($tmProfile as $profile)
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="file"
                                                class="form-control @error('userPhoto') is-invalid @enderror" id="userPhoto"
                                                name="userPhoto">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-6"><label class="labels"><strong>Address</strong></label>
                                        <input type="address" class="form-control @error('address') is-invalid @enderror"
                                            placeholder="your home address" id="address" name="address"
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-6"><label class="labels"><strong>ID number </strong></label>
                                        <input type="text"
                                            ...
                                            value="{{ $profile->ID_number }}" placeholder="id number" id="ID_number"
                                    ...
                                    {{-- <div class="col-md-6"><label class="labels"><strong>Business Name </strong></label>
                                        <input type="text"
                                            ...
                                            value="{{ $profile->businessName }}" placeholder="business name"
                                            id="businessName" name="businessName"required>
                                        @error('businessName')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    {{-- <div class="col-md-6"><label class="labels"><strong>Business Type</strong></label>
                                        <select id="businessType" name="businessType"
                                            class="form-control @error('businessType') is-invalid @enderror" required>
                                            <option value=""></option>
                                            @foreach ($businessType as $businessType)
                                                <option value="{{ $businessType->businessName }}"
                                                    {{ $profile->businessType === $businessType->businessName ? 'selected' : '' }}>
                                    ...
                                    {{-- <div class="col-md-6"> <label class="labels"><strong>Business Address
                                            </strong></label>
                                        <input type="text"
                                            class="form-control floating  @error('businessAddress') is-invalid @enderror"
                                            name="businessAddress" id="pac-input" tabindex="10"
                                            value="{{ $profile->businessAddress }}"required>
                                        <div id="map"></div>
                                ...
                                {{-- <div class="col-md-12">
                                    ...
                                    <img src="../../assets/licences_img/{{ $profile->licenceFilePath }}"
                                        class="rounded float-start" alt="{{ Auth::user()->userName }}" width="100rem"
                                        height="100rem">
                                    <input type="file"
                                        class="form-control   @error('licenceFilePath') is-invalid @enderror"
                                        value="" placeholder="" id="licenceFilePath" name="licenceFilePath">
                                    <input type="hidden" id="$request->licenceFilePath_recover"
                                        name="licenceFilePath_recover" value="{{ $profile->licenceFilePath }}">
                                ...
                                {{-- <div class="row mt-2">
                                    <div class="col-md-6"><label class="labels"><strong>Licence Number </strong> </label>
                                        <input type="text"
                                            ...
                                            value="{{ $profile->licenceNumber }}" placeholder="licence number"
                                            id="licenceNumber" name="licenceNumber"required>
                                        @error('licenceNumber')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    {{-- <div class="col-md-6"><label class="labels"><strong>Licence Issue Date
                                            </strong></label>
                                        <input type="date"
                                            class="form-control   @error('issueDate') is-invalid @enderror"
                                            value="{{ $profile->issueDate }}" placeholder="" id="issueDate"
                                    ...
                                    {{-- <div class="col-md-6"><label class="labels"><strong>Licence Expiry Date </strong>
                                        </label>
                                        <input type="date"
                                            class="form-control   @error('expiryDate') is-invalid @enderror"
                                            value="{{ $profile->expiryDate }}" placeholder="" id="expiryDate"
                                    ...
                                    {{-- <div class="col-md-6"><label class="labels"><strong>Tin Number</strong></label>
                                        <input type="text"
                                            ...
                                            placeholder="You Goverment Issued Tin Number" id="tinNumber"
                                    ...
                                    {{-- <div class="col-md-6"><label class="labels"><strong>Buisness Established
                                                At</strong></label>
                                        <input type="text"
                                            class="form-control   @error('businessEstablishmentYear') is-invalid @enderror"
                                            value="{{ $profile->businessEstablishmentYear }}" placeholder="eg: 2002"
                                            id="businessEstablishmentYear" name="businessEstablishmentYear"required>
