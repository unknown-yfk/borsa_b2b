                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center py-3 px-4">Ordered Quantity(PER UNIT)</th>
                    ...
                    <td class="align-middle p-4">ROM Accepted</td>
                    @elseif($item->status=="refusal")
                    <td class="align-middle p-4"> ROM Refused</td>
                    @elseif($item->status=="quantity_adjustment")
                    <td class="align-middle p-4"> ROM Adjusted Quantity</td>
                    @else
                    <td class="align-middle p-4"> ROM Adjusted Pending</td>
                    @endif
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center pb-4">
              ...
              <div class="d-flex">
                <div class="text-right mt-4">
                    ...
                    @if($total=="0")
                  <div class="text-large"><strong>Total Price: {{$item->totalPrice}} </strong></div>
                  @else
