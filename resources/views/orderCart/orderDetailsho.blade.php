                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive pt-3">
                    ...
                    @elseif($item->amount_status=="partial")
                     <td class="text-right font-weight-semibold align-middle p-4">{{$final_quantity=$item->partial_quantity}}</td>
                    <input type="hidden" {{$final_quantity=$item->partial_quantity}}/>

                    <td class="text-right font-weight-semibold align-middle p-4">{{$item->delivered_quantity - $item->partial_quantity }}</td>
                     @else
                    <td class="text-right font-weight-semibold align-middle p-4">{{$final_quantity=$item->delivered_quantity}}</td>
