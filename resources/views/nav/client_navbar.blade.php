<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark" style="background-color: #00008B !important">
    <!-- Navbar Brand-->
    {{-- <a class="navbar-brand ps-3" href="/client_dash"><h2><strong>Borsa</strong></h2></a> --}}
                  ...
                  <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic"
                      ...
                      <ul class="dropdown-menu dropdown-menu-end user-dd animated"
                          ...
                          <a class="dropdown-item" href="/client/create/post"><i
                            class="mdi mdi-settings me-1 ms-1"></i> Set-Up Account</a>
                          @else
                            <a class="dropdown-item" href="/clientProfile/show"><i
