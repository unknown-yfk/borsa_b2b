...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
                    ...
                    <div class="container px-3 my-5 clearfix">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h1>Delivery handing over to client </h1>
                            </div>
                    <div class="card-body">
            ...
            <form action="{{ ('/handover_to_client1/post/create') }}" method="POST">
             ...
             {{-- <select id="client" name="client" class="form-control" required>
                ...
                <option value="{{ $client->user_id }}" > {{ $client->firstName }} {{ $client->middleName }} {{ $client->lastName }}</option>
                @endforeach
                </select> --}}
                    <input type="hidden" value="{{ $clients[0]->user_id }}" name="client_user_id">


                    <label> You are handing over for : <strong> {{ $clients[0]->firstName }} {{ $clients[0]->middleName }} {{ $clients[0]->lastName }}</strong></label> <br>
