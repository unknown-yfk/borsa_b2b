...
@if(session()->has('message'))
 ...
 <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">RomDelivery</h4>

                  <p class="card-description">
                  <code>Delivery Handing Over to Rom</code>
                  </p>
                  {{-- <input id="myInput" type="text" placeholder="Search Orde here.."> --}}
           ...
           <div class="float-right col-md-3">
            ...
            <form action="{{ ('/key_distro/fetch_rom_id/post') }}" method="POST">
             ...
             <input type="hidden" value="{{ $hierarchy->id }}" name="hierarchy_id">
                @endforeach
             <label>Enter ROM unique id:</label>

                <input type="text" name="rom_unique_id" id="rom_unique_id" class="form-control col-md-3">
